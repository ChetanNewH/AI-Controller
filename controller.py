...
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        for handLms in results.multi_hand_landmarks:
            ...
            if mode == "VOLUME" and control_active:
            ...
            elif mode == "BRIGHTNESS" and control_active:
            ...
            if control_active:
                cv2.putText(img, "CONTROL: ON", (350,50),
                            cv2.FONT_HERSHEY_SIMPLEX,1,(0,255,0),2)
            else:
                cv2.putText(img, "CONTROL: OFF", (350,50),
